...
function procesarTexto(texto) {
  ...
  return texto
    ...
    .replace(
      /(Waseem\s*Hamid|Mohamed\s*Bouazizi|Abdellah\s*Yahyaoui\s*Azuz|Morsi|Yahya\s*Sinwar|Abu\s*Ubaidah|Al-Aqsa|Mezquita\s*de\s*Al-Aqsa|Gustavo\s*Petro|Marruecos|marroquí|Yemen|Egipto|de\s*los\s*Magribíes|Jalil\s*al-Hayya|مؤمن عليوة|Muhammad Qeriqaa|Anas Al-Sharif|Moamen Aliwa|Mamá|Lana|Muhammad Al-khalidi|محمد الخالدي|Ibrahim dahir|Muhammad Nofal|أنس الشريف|محمد قريقع|إبراهيم ظاهر|محمد نوفل)/giu,
      (match) => `<span class="nombre-profeta">${match}</span>`
    )
