...
const translations = {
  es: {
    IrAlIndicePrincipal: "Ir al Índice Principal",
  ...
  en: {
    IrAlIndicePrincipal: "Go to Main Index",
  ...
  ar: {
    IrAlIndicePrincipal: "اذهب إلى الفهرس الرئيسي",
  ...
  fr: {
    IrAlIndicePrincipal: "Aller à l'Index Principal",
